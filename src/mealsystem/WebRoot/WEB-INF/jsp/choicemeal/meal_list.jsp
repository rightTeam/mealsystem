			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="input-group">
						...
						<input type="hidden" type="text" id="tableid" name="tableid" value="">
				<input type="hidden" type="text" id="tabllenumber" name="tablenumber" value="">
				<select type="text" class="form-control"  id="t_number" value="10" style="width: 70px;">
				<c:forEach items="${tablenumber}" var="var" varStatus="vs">
							<option  id="${var.t_id}">
							${var.t_number}
							</option>
						</c:forEach>
				...
				<input type="text" class="form-control" name="o_piece" id="o_piece" value="" style="width: 50px;">
...
<script type="text/javascript">
	...
	function indent() {
		...
		$("#o_meal_id").val(ids);
		$("#tableid").val($("#t_number").find("option:selected").attr("id"));
		$("#tabllenumber").val($("#t_number").find("option:selected").val());
		$("#indentform").submit();
